...
a new one, click the respective button, then on the new page select 
the appropriate appointment information (date, location, 
type, and time) and click 'add to my appointments'.
